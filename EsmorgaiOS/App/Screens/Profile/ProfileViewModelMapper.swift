...
class ProfileViewModelMapper {
    func map(user: UserModels.User) -> ProfileModels.LoggedModel {
        ...
        let userItems = [
            ProfileModels.UserDataItem(
                title: LocalizationKeys.Profile.name.localize(),
                value: "\(user.name) \(user.lastName)",
                type: .name
            ),
            ProfileModels.UserDataItem(
                title: LocalizationKeys.Profile.email.localize(),
                value: user.email,
                type: .email
            )
        ]
        ...
        return ProfileModels.LoggedModel(
            ...
            optionsSection: ProfileModels.Options(
                title: LocalizationKeys.Profile.options.localize(),
                items: optionsItems
            )
        )
    }
